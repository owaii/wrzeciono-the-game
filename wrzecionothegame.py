            ...
            if Lasrespond == "a":
                ...
                if spadekrespond == "a":
                    ...
                    if grzerespond == "tak":
                        ...
                        time.sleep(2)
                        print("Grzesio opowiada ci o swoich przygodach...")
                        time.sleep(2)
                        print("Zaczyna ci się nudzić i prawie zasypiasz")
                        time.sleep(2)
                        print("Masz mroczki przed oczami...")
                        time.sleep(3)
                        print("Nagle Grzesio wstaje i prowadzi cię po pijaku do domu")
                        time.sleep(2)
                        print("Po drodze znajdujecie zadymiarzy")
                        time.sleep(4)
                        print("Zadyma?")
                        print('')
                        print("a) tak")
                        print("b) nie")
                        zadyma_las_choose = input('')
                        if zadyma_las_choose == "a":
                            zadyma()
                        elif zadyma_las_choose == "b":
                            time.sleep(2)
                            print("Omijacie zadymiarzy i bezpiecznie wracacie do domu")
                            time.sleep(3)
                            print("Nastaje nowy dzień")
                            time.sleep(2)
                    elif grzerespond  = "nie":
                        print("Grzesiu rozpina spodnie")
                        time.sleep(3)
                        print("Zdejmuje pasek")
                        time.sleep(2)
                        print("Zaczyna do ciebie biec wymachując paskiem...")
                        time.sleep(4)
                        print("Co robisz?")
                        print('')
                        print("a) uciekam")
                        print("b) jednak się przywitam")
                        grzesiu_pasek_respond = input('')
                        if grzesiu_pasek_respond == "a":
                            print("Gniew Grzesia cię dopada...")
                            time.sleep(2)
                            print("Czołgasz się z dala od niego ale finalnie cię dopada...")
                            time.sleep(2)
                            print("Twoje ostatnie słowa?")
                            ost_slowa = input('')
                            print(ost_slowa " - odpowiadasz")
                            time.sleep(2)
                            print("Brutalnie giniesz z ręki Grzesia.")
                            sys.exit("GAME OVER")
                        elif grzesiu_pasek_respond == "b":
                            print("Witasz się z nim i razem pijecie cytrynówke")
                            time.sleep(5)
                            print("Gniew Grzesia ustaje i znów się lubicie...")
                            time.sleep(2)
                            print("Grzesio opowiada ci o swoich przygodach...")
                            time.sleep(2)
                            print("Zaczyna ci się nudzić i prawie zasypiasz")
                            ...
                            if zadyma_las_choose == "a":
                                ...
                                print("Nastaje nowy dzień")
                                time.sleep(2)
                elif spadekrespond == "b":
                    print("*Płaczesz*")
                    time.sleep(3)
                    print("Jakaś random morda podchodzi i mówi:")
                    time.sleep(1)
                    print("- Hej lamerze! Na wrzecionie się nie płacze!")
                    time.sleep(1)
                    print("*Płaczesz dalej*")
                    time.sleep(2)
                    print("Tamten gość zaczyna podchodzić bliżej i wysuwa pięści gotowe do walki.")
                    time.sleep(2)
                    print("Wiem że płaczesz ale to czas na zadyme")
                    zadyma()
            elif Lasrespond == "b":
                print("*Szukasz wiewiórek*")
                time.sleep(2)
                print("Niestety tak od ciebie jedzie że wszystkie uciekają :(")
                time.sleep(3)
                print("Miłego szukania!")
                time.sleep(120)
                print("Po dwóch minutach szukania dalej nic nie znalazłeś")
                time.sleep(2)
                print("Wracasz do chałupy i masz dosyć wiewiórek.")
                time.sleep(3)
            elif Lasrespond == "c":
                print("Uderzasz w drzewo i nic się nie dzieje tylko boli cię głowa.")
                time.sleep(4)
            elif Lasrespond == "d":
                print("Idąc ścieżką, spotykasz znanego ci menela Grzesia. Przywitasz się?")
                grzerespond = input('')
                ...
                print("Śpisz i budzisz się w domu")
                time.sleep(10)
        #---------------------------------------------------------
